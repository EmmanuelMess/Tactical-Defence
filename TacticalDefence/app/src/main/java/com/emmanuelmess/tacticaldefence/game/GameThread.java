...
public class GameThread extends Thread {
	...
	/* Stuff for stats */
	private final DecimalFormat df = new DecimalFormat("0");  // no decimal places
	// Surface holder that can access the physical surface
	private final SurfaceHolder surfaceHolder;
	// The actual view that handles inputs
	// and draws to the surface
	private final RenderGameActivity gamePanel;
	...
	public GameThread(SurfaceHolder surfaceHolder, RenderGameActivity gamePanel) {
		super();
